...
class Calculator(tk.Tk):
    def init(self):
        ...
        self.create_button("+", button_frame,0,3, lambda: self.add_operation("+"),"red")

        self.create_button("-", button_frame,1,3, lambda: self.add_operation("-"),"red")

        self.create_button("*", button_frame,2,3, lambda: self.add_operation("*"),"red")

        self.create_button("/", button_frame,3,3, lambda: self.add_operation("/"),"red")
